 ...
 */
final class Version20180730153014 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE albums (id INT AUTO_INCREMENT NOT NULL, idartiste_id INT NOT NULL, nom VARCHAR(255) NOT NULL, annee VARCHAR(4) DEFAULT NULL, pochette VARCHAR(255) DEFAULT NULL, is_validated TINYINT(1) NOT NULL, INDEX IDX_F4E2474FEC7B457E (idartiste_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE artistes (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, genre VARCHAR(100) NOT NULL, is_validated TINYINT(1) NOT NULL, INDEX IDX_FDF1943FA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE relations (id INT AUTO_INCREMENT NOT NULL, sampleur_id INT NOT NULL, original_id INT NOT NULL, user_id INT DEFAULT NULL, articles_id INT DEFAULT NULL, is_validated TINYINT(1) NOT NULL, INDEX IDX_146CBF784E35BEC1 (sampleur_id), INDEX IDX_146CBF78108B7592 (original_id), INDEX IDX_146CBF78A76ED395 (user_id), INDEX IDX_146CBF781EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
