...
class TestData extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $relations=[
            ['sampleur'=>$this->getReference('California Love_track'), 'original'=>$this->getReference('Woman to Woman_track'),'isvalidated'=>1,'user'=>$this->getReference('Spakye'), 'article'=>$this->getReference('quand tupac shakur sample joe cocker_article')],
