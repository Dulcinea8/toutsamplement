...
Cinéma et hiphop font souvent bon ménage, et pour ma part je retiens des morceaux comme « Dernier domicile connu », et un de mes coups de coeur, le sample de la bande originale du Grand Blond par Gérard Baste et Pedro Winter.', 'auteur_id'=>$this->getReference('Spakye'), 'date_publi'=>'2018-07-23', 'image'=>'film.jpg'],
['titre'=>'Le Jour ou Daft Punk a créé "One More Time"', 'content'=>'« One More Time » passe sur le bloc opératoire. Les samples issus de « More Spell On You » d’Eddie Johns sont découpés au millimètre, et on découvre avec toujours autant de plaisir l’origine du titre de Daft Punk.Sans aucune hésitation, la meilleure explication de ce sample ! A la fois claire et limpide, tout est reproduit à l’identique… Alors si vous deviez expliquer à des amis l’origine du sample de « One More Time », voilà la meilleure vidéo possible à partager !<iframe width="560" height="315" src="https://www.youtube.com/embed/qrW7ugpEaLc" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>', 'auteur_id'=>$this->getReference('Tooty'), 'date_publi'=>'2018-07-21', 'image'=>'daft.jpg'],
